...
function makeFuncTester(arrOfTests) {
    return function(callback){
        if(callback(arrOfTests[0][0])===arrOfTests[0][1]
        &&callback(arrOfTests[1][0])===arrOfTests[1][1])
        return true;
        else
        return false;
    }
    ...
    return function(num1,num2){
        ...
        return function(){
            if(valid)
            {
                ...
                {
                    sum=array[iterator++ % array.length]+num1+num2;
                    count++;
                    if(sum<=21)
                    return sum;
                    else
                ...
                {
                    sum+=array[iterator % array.length];
                    iterator++;
                    if(sum<=21)
                    {
                        return sum;
